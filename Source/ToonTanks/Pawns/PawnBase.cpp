...
void APawnBase::RotateTurretTowardsTarget(FVector LookAtTarget) 
{
	// Update turret rotation to face towards given LookAtTarget from child classes
...
void APawnBase::HandleDestruction()
{
	...
	// -- pawn tank: inform game mode player died -> then hide all components and stop movement input
}
